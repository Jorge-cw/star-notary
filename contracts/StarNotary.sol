...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You don't own any of the stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You are not the owner of the star");
        //2. Use the transferFrom(from, to, tokenId); function to transfer the Star -- and check if sender is owner of tokenId
        // transferFrom(from, to, tokenId) checks if the msg sender is the owner of tokenId
